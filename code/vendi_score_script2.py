...
# bertopic_model = BERTopic(embedding_model="all-MiniLM-L6-v2")  # Replace with your preferred embedding model

# # Fit BERTopic to the dataset
# bertopic_model.fit(cleaned_sents)

# # Transform sentences to get document embeddings
# _, bertopic_embeddings = bertopic_model.transform(cleaned_sents)  # Transform returns (topics, embeddings)

# # Save BERTopic embeddings
# features["BERTopic"] = bertopic_embeddings
...
# # Fit BERTopic to the dataset and extract document embeddings
# topics, bertopic_embeddings = bertopic_model.fit_transform(cleaned_sents)

# # Ensure embeddings are a valid 2D NumPy array
